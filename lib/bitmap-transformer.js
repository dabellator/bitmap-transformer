'use strict';
// var transform = module.exports = exports = function(){

  var fs = require('fs');
  var os = require('os');

  //file to read is 1st command line arg
  var rStream = fs.createReadStream(__dirname + '/' + process.argv[2]);
  // file to write to is 2nd command line arg
  var wStream = fs.createWriteStream(__dirname + '/' + process.argv[3]);
